...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projetc__

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projetc__: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projetc__ ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/progEcrire.o: progEcrire.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/progEcrire.o progEcrire.cpp

${OBJECTDIR}/progLire.o: progLire.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/progLire.o progLire.cpp

${OBJECTDIR}/progPour.o: progPour.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/progPour.o progPour.cpp

${OBJECTDIR}/progRepeter.o: progRepeter.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/progRepeter.o progRepeter.cpp

${OBJECTDIR}/progSelon.o: progSelon.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/progSelon.o progSelon.cpp

${OBJECTDIR}/progSi.o: progSi.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/progSi.o progSi.cpp

${OBJECTDIR}/progTantQue.o: progTantQue.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/progTantQue.o progTantQue.cpp
...
${OBJECTDIR}/progEcrire_nomain.o: ${OBJECTDIR}/progEcrire.o progEcrire.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/progEcrire_nomain.o progEcrire.cpp;\
	else  \
...
${OBJECTDIR}/progLire_nomain.o: ${OBJECTDIR}/progLire.o progLire.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/progLire_nomain.o progLire.cpp;\
	else  \
...
${OBJECTDIR}/progPour_nomain.o: ${OBJECTDIR}/progPour.o progPour.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/progPour_nomain.o progPour.cpp;\
	else  \
...
${OBJECTDIR}/progRepeter_nomain.o: ${OBJECTDIR}/progRepeter.o progRepeter.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/progRepeter_nomain.o progRepeter.cpp;\
	else  \
...
${OBJECTDIR}/progSelon_nomain.o: ${OBJECTDIR}/progSelon.o progSelon.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/progSelon_nomain.o progSelon.cpp;\
	else  \
...
${OBJECTDIR}/progSi_nomain.o: ${OBJECTDIR}/progSi.o progSi.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/progSi_nomain.o progSi.cpp;\
	else  \
...
${OBJECTDIR}/progTantQue_nomain.o: ${OBJECTDIR}/progTantQue.o progTantQue.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/progTantQue_nomain.o progTantQue.cpp;\
	else  \
